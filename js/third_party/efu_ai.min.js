class efuAI {
    ...
    init() {
        // 从配置中读取 API 地址和密钥
        this.root = this.config.apiUrl; // 从 post_ai 中读取 apiUrl
    ...
    async fetch(title, content) {
        const url = `${this.root}/chat/completions`;
        const body = {
