...
class efuAI {
  ...
  async fetch(content) {
    ...
    try {
        const response = await fetch(this.config.apiUr, {
            method: "POST",
            headers: {
