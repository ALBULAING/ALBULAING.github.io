...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const msgToTraditionalChinese = '<i class="heoblogIcon icon-panben"></i><span>轉為繁體</span>' // 此處可以更改為你想要顯示的文字
  const msgToSimplifiedChinese = '<i class="heoblogIcon icon-jianben"></i><span>转为简体</span>' // 同上，但兩處均不建議更改
